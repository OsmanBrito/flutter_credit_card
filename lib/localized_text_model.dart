class LocalizedText {
  const LocalizedText({
    ...
    this.cardCPFLabel = _cardCPFLabelDefault,
    this.cardCPFHint = _cardCPFHintDefault,
  });
  ...
  static const String _cardCPFLabelDefault = 'CPF';
  static const String _cardCPFHintDefault = 'xxx.xxx.xxx-xx';
  ...
  final String cardCPFHint;
  final String cardCPFLabel;
}
